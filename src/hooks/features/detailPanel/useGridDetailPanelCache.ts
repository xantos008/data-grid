...
function cacheContentAndHeight(
  ...
  getDetailPanelContent: DataGridExtraProcessedProps['getDetailPanelContent'],
  getDetailPanelHeight: DataGridExtraProcessedProps['getDetailPanelHeight'],
...
export const useGridDetailPanelCache = (
  apiRef: React.MutableRefObject<GridApiExtra>,
  props: Pick<DataGridExtraProcessedProps, 'getDetailPanelContent' | 'getDetailPanelHeight'>,
) => {
