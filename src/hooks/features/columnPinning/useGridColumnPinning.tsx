...
import { filterColumns } from '../../../components/DataGridExtraVirtualScroller';

export const columnPinningStateInitializer: GridStateInitializer<
  Pick<DataGridExtraProcessedProps, 'pinnedColumns' | 'initialState' | 'disableColumnPinning'>
> = (state, props, apiRef) => {
...
const mergeStateWithPinnedColumns =
  ...
  (state: GridStateExtra): GridStateExtra => ({ ...state, pinnedColumns });
