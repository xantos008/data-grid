...
interface DataGridExtraVirtualScrollerProps extends React.HTMLAttributes<HTMLDivElement> {
  disableVirtualization?: boolean;
}

const DataGridExtraVirtualScroller = React.forwardRef<
  HTMLDivElement,
  DataGridExtraVirtualScrollerProps
>(function DataGridExtraVirtualScroller(props, ref) {
...
export { DataGridExtraVirtualScroller };
