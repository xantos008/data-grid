...
import { filterColumns } from './DataGridExtraVirtualScroller';
...
interface DataGridExtraColumnHeadersProps extends React.HTMLAttributes<HTMLDivElement> {
  innerRef?: React.Ref<HTMLDivElement>;
}

export const DataGridExtraColumnHeaders = React.forwardRef<
  HTMLDivElement,
  DataGridExtraColumnHeadersProps
>(function DataGridExtraColumnHeaders(props, ref) {
