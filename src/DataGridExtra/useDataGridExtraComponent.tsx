...
export const useDataGridExtraComponent = (
  inputApiRef: React.MutableRefObject<GridApiExtra> | undefined,
  props: DataGridExtraProcessedProps,
) => {
  const apiRef = useGridInitialization<GridPrivateApiExtra, GridApiExtra>(inputApiRef, props);
