...
/**
 * The props users can give to the `DataGridExtraProps` component.
 */
...
export type DataGridExtraForcedPropsKey = 'signature';

/**
 * The `DataGridExtra` options with a default value overridable through props
